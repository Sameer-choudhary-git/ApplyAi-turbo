      ...
      <Card className="border-border/50 bg-card/50 backdrop-blur-sm overflow-hidden h-full">
        <div className="px-6 py-5 border-b border-border/50 flex items-center justify-between bg-muted/10">
          <div>
            ...
            <h3 className="font-heading font-bold text-lg mt-0.5 text-foreground">
              Recent Applications
            </h3>
          </div>
          <Link
            to="/applications"
            className="text-xs text-primary font-bold tracking-wide hover:text-primary/80 transition-colors"
          >
            VIEW ALL
          </Link>
        </div>
          ...
          {recent.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-14 px-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-2 max-w-[280px] leading-relaxed">
                EngiBuddy is scanning platforms for roles that match your
                profile. Activity will appear here soon.
              </p>
            </div>
          ) : (
