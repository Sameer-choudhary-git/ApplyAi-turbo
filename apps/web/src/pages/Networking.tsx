...
const mockContacts = [
  ...
  },
  {
    ...
    relationship: "peer",
    status: "connected",
    notes: "Same university alumni group.",
    referral_potential: false,
  },
  {
    id: 3,
    ...
    relationship: "mentor",
    status: "pending",
    notes: "Reached out for portfolio review.",
    referral_potential: true,
  },
];
...
export default function Networking() {
  ...
  const handleAddContact = (newContact: typeof empty) => {
    setContacts([
      { ...newContact, id: Math.max(...contacts.map((c) => c.id), 0) + 1 },
      ...contacts,
    ]);
    setOpen(false);
    setForm(empty);
  ...
  const recruiters = contacts.filter(
    (c) => c.relationship === "recruiter",
  ).length;
            ...
            <div className="space-y-4 mt-2">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="mt-1.5 h-20 bg-background/50 border-border/50"
                />
              </div>
              <Button
                className="w-full gradient-primary text-white border-0 mt-4 glow-primary"
                  ...
                  <div>
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <button
                        ...
                        className="opacity-0 group-hover:opacity-100 transition-opacity text-muted-foreground hover:text-rose-400 p-2 hover:bg-rose-500/10 rounded-lg"
                      >
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      <Badge
                        variant="outline"
                        className={`text-[10px] font-semibold uppercase tracking-wider ${RELATIONSHIP_COLORS[contact.relationship]}`}
                      >
